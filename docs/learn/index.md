...
10. **[Marble Testing](marble-testing.md)**: `TestScheduler`, virtual time, and marble diagrams. Prove a debounced search pipeline, including its cancellation, in a test that runs in milliseconds.
